                                            ...
                                            <div class="direct-chat-contacts">
                                                <ul class="contacts-list">
                                                    <li>
                                                        <a href="#">
                                                            <img class="contacts-list-img"
                                                                src="{{ asset('template/dist/img/user1-128x128.jpg') }}" alt="User Image">
                                                    ...
                                                    <li>
                                                        <a href="#">
                                                            <img class="contacts-list-img"
                                                                src="{{ asset('template/dist/img/user7-128x128.jpg') }}" alt="User Image">
                                                    ...
                                                    <li>
                                                        <a href="#">
                                                            <img class="contacts-list-img"
                                                                src="{{ asset('template/dist/img/user3-128x128.jpg') }}" alt="User Image">
                                                    ...
                                                    <li>
                                                        <a href="#">
                                                            <img class="contacts-list-img"
                                                                src="{{ asset('template/dist/img/user5-128x128.jpg') }}" alt="User Image">
                                                    ...
                                                    <li>
                                                        <a href="#">
                                                            <img class="contacts-list-img"
                                                                src="{{ asset('template/dist/img/user6-128x128.jpg') }}" alt="User Image">
                                                    ...
                                                    <li>
                                                        <a href="#">
                                                            <img class="contacts-list-img"
                                                                src="{{ asset('template/dist/img/user8-128x128.jpg') }}" alt="User Image">
                                    ...
                                    <ul class="products-list product-list-in-box">
                                        <li class="item">
                                            <div class="product-img">
                                                <img src="{{ asset('template/dist/img/default-50x50.gif') }}" alt="Product Image">
                                            </div>
